<html>
<head>
<title>rednaxela :: Javascript PDU Converter for GSM SMS</title>
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
<meta http-equiv="Content-Language" content="en-gb">
<style TYPE="text/css">
<!--
	BODY {font-weight:bold;font-family: "Century Gothic", "Frutiger", "Verdana", "Helvetica", sans-serif;}
-->
</style>
...
<tr>
<td>
<b><font size="5">Javascript PDU Converter</font></b>
<!-- The link to Swen-Peter no longer works... needs tidying up. TODO
<font size=2>Written by <a href="http://home.student.utwente.nl/s.p.ekkebus/portfolio/">Swen-Peter Ekkebus</a>
</font>
-->
<font size=2>Written by <span title="The link to Swen's copy of the page no longer works">Swen-Peter Ekkebus</span>
<a href="http://www.linkedin.com/in/ekkebus" style="text-decoration:none;"><img src="http://www.linkedin.com/img/webpromo/btn_in_20x15.gif" width="20" height="15" alt="View Swen-Peter Ekkebus's LinkedIn profile" style="vertical-align:middle" border="0"></a>
</font>
<br />
<font size=2>Updated by <a href="/">Andrew Alexander</a>&nbsp;




<a href="http://www.linkedin.com/in/andrewalexander" style="text-decoration:none;"><span style="font: 80% Arial,sans-serif; color:#0783B6;"><img src="http://www.linkedin.com/img/webpromo/btn_in_20x15.gif" width="20" height="15" alt="View Andrew Alexander's LinkedIn profile" style="vertical-align:middle" border="0"> </span></a>
(v1.5)</font><font size=2> and Milan Chudik (v1.4)</font>


<br /><br />
I am available for work so check out my details on <a href="http://www.linkedin.com/in/andrewalexander" style="text-decoration:none;">
LinkedIn</a> and <a href="/">contact me</a>.
<br />
<br />
<font size="1">PDU Format Converter (Encoder/Decoder) for GSM SMS. This release v1.5r9.
...
<table cellspacing="0" cellpadding="5" border="0">
  <tbody>
  <tr>
    <td align="center">PDU SMS message creator</td><td align="center">Hexadecimal PDU Message Entry/Display</td><td align="center">Resultant 7/8/16 Bit readable PDU Message</td>
  </tr>
  ...
  <tr>
	...
	<tr>
		<td>SMSC</td>
		<td><input type="text" name="smscNumber" size="15" value="+44000000000"></td>
	</tr>
	<tr>
		<td>Receiver</td>
		<td><input type="text" name="phoneNumber" size="15" value="01000000000"></td>
	</tr>
	<tr>
	<td>Alphabet Size</td><td>
	<INPUT TYPE="RADIO" CHECKED name="size" value=7 onclick="maxkeys = 160;">7<INPUT TYPE="RADIO" name="size" value=8 onclick="maxkeys = 140;">8<INPUT TYPE="RADIO" name="size" value=16 onclick="maxkeys = 70;">16
	</td>
	</tr>
	<tr>
	<td>Message Class</td>
	...
	<tr>
		<td>Receipt</td><td><INPUT TYPE="CHECKBOX" name="receipt"></td>
	</tr>
	<tr>
		<td>Validity (Relative)</td>
		<td><INPUT TYPE="CHECKBOX" name="vFlag" onclick="checkFlag(this);"><input type="text" name="valid" size="3" value="" onkeyup="document.getElementById('validy').innerHTML=Validity(this.value)" disabled="true"><span id="validy" align=left></span> </td>
	</tr>
	</tbody>
	</table>
    ...
    <td valign="top" align="center" width="200">
      <br /><br /><br /><textarea name="smsText2" rows="18" wrap="virtual" cols="20">07911326040000F004 0B911346610089F600 00208062917314080C C8F71D14969741F977 FD07</textarea> 
      </td>
    <td valign="top" width="250">
      <br /><br /><br /><textarea name="smsOut" rows="18" wrap="virtual" cols="22"></textarea>
    </td>
    </tr>
  ...
  <tr>
    <td align="center"><input onclick="smsText2.value= stringToPDU(document.pduToStringForm.smsText.value.substring (0, maxkeys),document.pduToStringForm.phoneNumber.value,document.pduToStringForm.smscNumber.value,document.pduToStringForm.size,document.pduToStringForm.mclass.value,document.pduToStringForm.valid.value,document.pduToStringForm.receipt);" type="button" size="11" value="Convert >" name="stringButton"></td>
    <td align="center">
      <p align="center">
      <input onclick="smsOut.value= getPDUMetaInfo(document.pduToStringForm.smsText2.value);" type="button" size="11" value="Convert >" name="checkButton">
      </p>
    </td>
    <td align="center">
      <p align="left">
      <small><a href="javascript:showCalculation();">Show User data translation (7 bit only)</a></small>
      </p>
    </td>
  </tr>
...
SMS (Short Message Service) can contain up to 160 characters, using the <a href="javascript:show('7%20bits%20default%20table',printDefaultAlphabet());">
7-bits GSM default alphabet</a> or 140 characters for an 8 bit alphabet or 70 characters for a 16 bit UCS-2 alphabet.
<br />
...
<SMALL><p>This current version has several specific shortcomings (and more). One of these is it doesn't attempt to deal with embedded headers at the start of messages. It isn't meant to be a replacement for a tool like <a href="http://www.nobbi.com/pduspy.htm">pduspy</a></p>



<script type="text/javascript"><!--
google_ad_client = "pub-0421527979476831";
// simple 728x90, created 17/04/08 
google_ad_slot = "2394745265";
google_ad_width = 728;
google_ad_height = 90;
//-->
</script>
...
<a href="http://www.dreamfabric.com/sms/">Lars Pettersson's 'SMS and the PDU format'</a><br />
<a href="http://www.3gpp.org/ftp/Specs/html-info/23040.htm">Technical realization of the Short Message Service 3GPP</a> TS 23.040 V6.5.0 (2004-09)<br />
<a href="http://www.3gpp.org/ftp/Specs/html-info/23038.htm">Alphabets and language-specific information 3GPP</a> TS 23.038 V6.1.0 (2004-09)<br />
<a href="http://www.3gpp.org/ftp/Specs/html-info/23042.htm">Compression algorithm for text messaging services 3GPP</a> TS 23.042 V5.0.0 (2002-06)<br />
<a href="http://www.3gpp.org/ftp/Specs/html-info/27005.htm">Use of DTE-DCE interface for SMS and CBS 3GPP</a> TS 27.005 V5.0.0 (2002-06)<br />
<a href="http://www.3gpp.org/ftp/Specs/html-info/27007.htm">AT command set for User Equipment 3GPP</a> TS 27.007 V6.6.0 (2004-09)<br />
<a href="http://www.3gpp.org/ftp/Specs/html-info/24011.htm">PP SMS support on mobile radio interface 3GPP</a> TS 24.011 V6.0.0 (2003-09)<br />
Other Links:<br />
<a href="http://www.etsi.org/">ETSI</a>/<a href="http://www.3gpp.org/">3GPP</a><br />
<a href="http://www.3gpp.org/specs/numbering.htm">3GPP Specification page</a><br />
</p>




<small>Page last updated on
Wednesday 9<sup><small>th</small></sup> July 2014 05:25 pm GMT</td>
</tr>
</table>
</center>
