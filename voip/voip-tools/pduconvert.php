<!-- Copy from http://smstools3.kekekasvi.com/topic.php?id=288 -->
<HTML>
...
sevenbitdefault = new Array(
	...
	'P',	'Q',	'R',	'S',	'T',	'U',	'V',	'W',	'X',	'Y',	'Z',	'?',	'?',	'?',	'ü',	'§',
	'?',	'a',	'b',	'c',	'd',	'e',	'f',	'g',	'h',	'i',	'j',	'k',	'l',	'm',	'n',	'o',
	'p',	'q',	'r',	's',	't',	'u',	'v',	'w',	'x',	'y',	'z',	'?',	'?',	'?',	'ü',	'à'
);
...
function memo_samples()
{
	var elem = document.getElementById('smsMemo');
	elem.value += "\nPDU's with GSM 7bit characters:\n"+
"\n\n"+
"\n"+
"\n"+
"First part of concatenated message, alphanumeric sender:\n"+
"\n"+
"\n";
}
...
function clearAll()
{
	...
	document.getElementById('pduTool').ussdText.value ="";
	document.getElementById('smsOut').innerHTML = "<BR><BR>";
...
<form name="pduToStringForm" id="pduTool">
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<TR>
			...
			<TD>
				<select name="to_toa">
					...
					<option value="145">International
					<option value="161">National
					<option value="129">Unknown
				</select>
			</TD>
		...
		<TR>
			...
			<TD>
				<select name="mclass">
					...
					<option value="0">Flash
					<option value="1">ME specific
					<option value="2">SIM specific
					<option value="3">TE specific
				</select>
			</TD>
		...
		<TR>
			...
			<TD>
				...
				<span id="validy" align=left></span>
			</TD>
		...
		<TR>
			...
			<TD>Characters: &nbsp; 
				<label name="counter" id="counter" size="5"></label> &nbsp; 
				<label id="counter_notice"></label>
			</TD>
			<TD align="right">
				<input onclick="smsText2.value=stringToPDU(
					...
					document.getElementById('pduTool').valid.value,
					document.getElementById('pduTool').receipt);"
					type="button" value="Convert >" name="stringButton">&nbsp;
			</TD>
		</TR>
	</table>
	...
	<table width="99%" cellspacing="0" cellpadding="1" border="0">
		<TR>
			<TD colspan="2"><b>PDU Message Entry/Display</b><BR>
			</TD>
		</TR>
		<TR>
			<TD colspan="2">
				<textarea name="smsText2" rows="4" wrap="virtual" style="font-family: monospace; width: 99%;"></textarea> 
			</TD>
		</TR>
		<TR>
			<TD>
			...
			<TD align="right">
<!--
				<input onclick="smsOut.value= getPDUMetaInfo(document.getElementById('pduTool').smsText2.value);" type="button" size="11" value="Convert >" name="checkButton">
-->
				<input onclick="document.getElementById('smsOut').innerHTML= '<BR>'+getPDUMetaInfo(document.getElementById('pduTool').smsText2.value, '<BR>', '<BIG>', '</BIG>').replace(/\n/g, '<BR>')+'<BR><BR>';" type="button"value="Convert >" name="checkButton">&nbsp;
	...
	<table width="99%" cellspacing="0" cellpadding="1" border="0">
		<TR>
			<TD colspan="2"><b>USSD Entry/Display</b>
				&nbsp;
				<INPUT TYPE="RADIO" CHECKED name="ussd" value=7 onclick="change_ussd(0);">GSM 7bit packed
				<INPUT TYPE="RADIO" name="ussd" value=16 onclick="change_ussd(0);">UCS2
				&nbsp;
				<INPUT TYPE="CHECKBOX" name="cell_broadcast" id="cell_broadcast">Cell Broadcast (whole PDU)
			</TD>
		</TR>
		<TR>
			<TD colspan="2">
				<textarea name="ussdText" id="ussdText" rows="3" wrap="virtual" style="font-family: monospace; width: 99%;"></textarea> 
			</TD>
		</TR>
		<TR>
			<TD><label id="ussd_label"><SMALL><i>( Padding as defined on GSM 03.38 version 5.6.1 (ETS 300 900) page 17 )</i></SMALL></label>
			</TD>
			<TD align="right">
				<input onclick="document.getElementById('smsOut').innerHTML = '<BR>'+decode_ussdText(document.getElementById('pduTool').ussdText.value,document.getElementById('pduTool').cell_broadcast.checked).replace(/\n/g, '<BR>')+'<BR><BR>';" type="button"value="Convert >" name="checkButton">&nbsp;
			</TD>
		</TR>
	</table>
	...
	<table width="99%" cellspacing="0" cellpadding="1" border="0">
		...
		<TR>
			<TD colspan="2">
				<div class="box" name="smsOut" id="smsOut"><BR><BR></div>
			</TD>
		</TR>
		<TR>
			<TD>
				<a href="javascript:showCalculator();">Calculator</a> &nbsp;
				<a href="javascript:showCalculation();">User data translation (7 bit only)</a>
			</TD>
			<TD align="right">
				<INPUT TYPE="CHECKBOX" name="quote_memo">Quote &nbsp;
				<input onclick="javascript:add_to_memo(document.getElementById('smsOut').innerHTML);" type="button" value="Add to memo >" name="checkButton">&nbsp;
			</TD>
		</TR>
	</table>
	...
	<table width="99%" cellspacing="0" cellpadding="1" border="0">
		<TR>
			<TD><b>Memo</b> &nbsp; <SMALL>( <a href="javascript:memo_samples();">add sample PDU's</a> )</SMALL>
			</TD>
			<TD align="right">
				<SMALL>Size: <a href="javascript:sizeMemo(+10);">Increase</a> &nbsp; <a href="javascript:sizeMemo(-5);">Decrease</a></SMALL>&nbsp;
			</TD>
		</TR>
		<TR>
			<TD colspan="2">
				<textarea name="smsMemo" id="smsMemo" rows="10" wrap="virtual" style="font-family: monospace; width: 99%;"></textarea> 
			</TD>
		</TR>
		<TR>
			<TD>
			...
			<TD align="right">
				<input onclick="document.getElementById('smsMemo').value = '';" type="button" value="Clear memo" name="checkButton">&nbsp;
			</TD>
		</TR>
	</table>
</form>

<a href="javascript:show('7%20bits%20default%20table',printDefaultAlphabet());">7-bits GSM default alphabet</a>
...
<!--
	...
	var pdu = getQueryVariable("pdu");
	if (pdu != "")
	{
		document.getElementById('pduTool').smsText2.value = pdu;
		document.getElementById('smsOut').innerHTML= '<BR>'+getPDUMetaInfo(document.getElementById('pduTool').smsText2.value, '<BR>', '<BIG>', '</BIG>').replace(/\n/g, '<BR>')+'<BR><BR>';
	}
