...
// Commonish...
		...
		out +=  "SMS Center Address: "+SMSC_Number+"\nRecipient Address: "+sender_number+"\nMessage Ref: "+MessageReference+"\nTimeStamp: "+timeStamp+"\nTimeStamp2: "+timeStamp2 + "\nStatus Byte: " + mStatus;
...
// Commonish...
		...
		out =  "Message Type: SMS Status Report\n";
...
<table width="100%" border="5" cellpadding="5" cellspacing="0">
	<caption>PDU Format Converter (Encoder/Decoder) for GSM SMS</caption>
	<tbody>
        <tr>
          <td width="263" align="center" valign="top"><div align="center">SMS Options</div></td>
          <td width="220"><div align="center">SMS Message</div></td>
          <td width="210"><div align="center">PDU Message</div></td>
          <td width="256"><div align="center">Result Message</div></td>
        </tr>
        <tr>
        	<td height="294" align="center" valign="top">
...
<table width="100%" height="272">
	...
	<tr>
		<td>Alphabet Size</td>
		<td>
			<INPUT TYPE="RADIO" CHECKED name="size" value=7 onClick="maxkeys = 160;">7
			<INPUT TYPE="RADIO" name="size" value=8 onClick="maxkeys = 140;">8
			<INPUT TYPE="RADIO" name="size" value=16 onClick="maxkeys = 70;">16
		</td>
	</tr>
	<tr>
		<td>Message Class</td>
	...
	<tr>
		<td>Receipt</td>
		<td><INPUT TYPE="CHECKBOX" name="receipt"></td>
	</tr>
	<tr>
		<td>Validity (Relative)</td>
		<td>
			<INPUT TYPE="CHECKBOX" name="vFlag" onClick="checkFlag(this);">
			<input type="text" name="valid" size="3" value="" onKeyUp="document.getElementById('validy').innerHTML=Validity(this.value)" disabled="true">
...
<table width="100%" height="237">
	...
	<tr><td height="23"><div align="center">
	  <input onClick="smsOut.value= getPDUMetaInfo(document.pduToStringForm.smsText2.value);" type="button" size="11" value="Convert >" name="checkButton">
            ...
            <td>
<table width="100%" height="212">
	<!-- <caption>Result Message</caption> -->
	<tr><td height="183"></th>
	  <textarea name="smsOut" cols="30" rows="15" wrap="virtual"></textarea></td>
	<tr><td height="21" align="center"><div align="center"><a href="javascript:showCalculation();">Show User data translation (7 bit only)</a></div></td></tr>
</table>
		  </td>
    	</tr>
	</tbody>
